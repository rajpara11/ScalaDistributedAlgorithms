...
object Driver extends Application {
	...
	node2.setNeighbors(List(node1, node3, node4, node5))
	node3.setNeighbors(List(node1, node2))
	node4.setNeighbors(List(node2, node5))
	node5.setNeighbors(List(node2, node4))
